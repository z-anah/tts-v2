...
function goToReading() {
  router.push(`/paired-opposites/topic/${topicId}/reading`);
}

function goToShowMe() {
  router.push(`/paired-opposites/topic/${topicId}/showme`);
}

function goToGrid() {
  router.push(`/paired-opposites/topic/${topicId}/grid`);
}

function goToPictureQuiz() {
  router.push(`/paired-opposites/topic/${topicId}/picturequiz`);
}
